...
const logFormatter = (options) =>
  `${options.timestamp()} - ${pad(LOG_LEVEL_PADDING, options.level.toUpperCase(), true)}[${((options.meta && options.meta.js) ? pad(FILE_NAME_PADDING, options.meta.js, true) : pad(FILE_NAME_PADDING, '', true))}] - ${(options.message ? options.message : '')}`;
